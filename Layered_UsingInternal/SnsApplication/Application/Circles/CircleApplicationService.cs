...
using SnsApplication.Application.Circles.Create;
using SnsApplication.Application.Circles.Delete;
using SnsApplication.Application.Circles.Get;
using SnsApplication.Application.Circles.GetAll;
using SnsApplication.Application.Circles.Join;
using SnsApplication.Application.Circles.Update;
